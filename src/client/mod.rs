...
pub struct Client<C> {
    connector: C,
    handle: Handle,
    sockets: RefCell<Vec<::tokio_proto::Client<http::MessageHead<http::RequestLine>, http::MessageHead<http::RawStatus>, ::futures::stream::Receiver<Vec<u8>, ::Error>, Body<Vec<u8>, ::Error>, ::Error>>>,
}
